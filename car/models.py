...
class Transact(models.Model):
    ...
    buyer = models.ForeignKey(People, models.DO_NOTHING, blank=True, null=True,related_name='buyer')
    car = models.ForeignKey(Car, models.DO_NOTHING, blank=True, null=True)
    seller = models.ForeignKey(People, models.DO_NOTHING, blank=True, null=True,related_name='seller')
    trans_time = models.DateField(auto_now_add=True)

    def save(self, *args, **kwargs):
        self.seller = self.car.owner
