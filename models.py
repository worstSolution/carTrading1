...
class Transact(models.Model):
    ...
    seller = models.ForeignKey(People, models.DO_NOTHING, blank=True, null=True)
    buyer = models.ForeignKey(People, models.DO_NOTHING, blank=True, null=True)
    car = models.ForeignKey(Car, models.DO_NOTHING, blank=True, null=True)
    trans_time = models.DateField(blank=True, null=True)
